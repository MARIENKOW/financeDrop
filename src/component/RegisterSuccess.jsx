...
const RegisterSuccess = ({ mail }) => {
   return (
      <Box maxWidth={450} p={1} margin={'0 auto'} flex={1} gap={2} display={'flex'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'}>
         ...
         <Typography textAlign={'center'} variant='h6' color="initial">Ми надіслали посилання на пошту{mail && `: "${mail}"`} для активації облікового запису.</Typography>
         <Typography textAlign={'center'} variant='h6' color="initial">Посилання буде активне протягом {ACTIVATE_TOKEN_TIME} хвилин</Typography>
