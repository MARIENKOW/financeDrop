...
const RegisterSuccess = ({ mail }) => {
   return (
      <Box maxWidth={450} p={1} margin={'0 auto'} flex={1} gap={2} display={'flex'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'}>
         ...
         <Typography textAlign={'center'} variant='h5' color="initial">We have sent the link to the mail{mail && `: "${mail}"`} to activate the account.</Typography>
         <Box>
            <Typography textAlign={'center'} variant='body1' color="text.secondary">The link will be active for {ACTIVATE_TOKEN_TIME} minutes</Typography>
