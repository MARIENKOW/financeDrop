...
export const StyledNumberField = ({ startAdornment, label,errors,register ,options,errMessage = 'incorrect data',sx}) => {
   return (
      <StyledFormControl sx={{width:'100%',...sx}} error={!!errors[register.name]} variant="filled">
