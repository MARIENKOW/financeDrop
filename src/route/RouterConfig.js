...
const RouterConfig = createBrowserRouter([
   {
      ...
      children: [
         {
            element:<OnlyLoginUser> <UserAccountWrapper /></OnlyLoginUser>,
            errorElement: <ErrorPage />,
            path:'/',
            children: [
               {
   ...
   },
   {
      ...
      children: [
         {
            element:<OnlyLoginAdmin> <AdminAccountWrapper /></OnlyLoginAdmin>,
            errorElement: <ErrorPage />,
            path:'/Admin',
            children: [
               {
         ...
         {
            element: <OnlyLogoutAdmin><SignInAdmin/></OnlyLogoutAdmin>,
            path: '/Admin/SignIn',
            errorElement: <ErrorPage />,
         },
      ]
